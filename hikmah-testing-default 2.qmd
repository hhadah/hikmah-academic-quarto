...
subtitle: Anti-Asian Bias
short-title: Ex
published: "Under review at *Hello There*"
  ...
  - name: Hussain Hadah
    ...
    affiliations: 
      - id: hhadah
        ...
        department: Economics and Murphy Institute
...
```{r}
#| label: tbl-star-trek-characters
#| tbl-cap: "Main Characters from Star Trek: Deep Space Nine"
#| echo: false

library(knitr)
library(kableExtra)

star_trek_chars <- data.frame(
  Name = c("Benjamin Sisko", "Kira Nerys", "Odo", "Jadzia Dax", "Julian Bashir"),
  Rank = c("Captain", "Colonel", "Constable", "Lieutenant", "Chief Medical Officer"),
  Species = c("Human", "Bajoran", "Changeling", "Trill", "Human"),
  Key_trait = c("Emissary of the Prophets", "Former resistance fighter", "Shapeshifter", "Joined with symbiont", "Genetically enhanced")
)

if (knitr::is_latex_output()) {
  kable(star_trek_chars, format = "latex", booktabs = TRUE, align = c('l', 'l', 'l', 'l')) %>%
    kable_styling(latex_options = c("striped", "hold_position"), full_width = FALSE)
} else if (knitr::is_html_output()) {
  kable(star_trek_chars, format = "html", align = c('l', 'l', 'l', 'l')) %>%
    kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)
} else {
  kable(star_trek_chars, format = "pipe", align = c('l', 'l', 'l', 'l'))
}
```
